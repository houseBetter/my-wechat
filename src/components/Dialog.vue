            ...
            <div class="msg-list">
                <div class="msg-row">
                    ...
                    <div class="msg-box">
                        ...
                        人世间最痛苦的事莫过于此。 如果上天能够给我一个再来一次的机会，
                        我会对那个女孩子说三个字：我爱你。 如果非要在这份爱上加上一个期限，
                        我希望是…… 一万年！！
...
.content .msg-list .msg-row img,
.content .msg-list .msg-row-me img{
    width:35px;
    height: 35px;
}

.content .msg-list .msg-row .msg-box{
    /* width: 246px; */
    /* height: 82px; */
    padding: 8px 8px;
    margin-left: 10px;
...
.content .msg-list .msg-row .msg-box::before{
    content: "";
    position: absolute;
    width:0;
    height: 0;
...
.content .msg-list .msg-row-me .msg-box{
    /* width: 246px; */
    /* height: 82px; */
    padding: 8px 8px;
    margin-right: 10px;
...
.content .msg-list .msg-row-me .msg-box::after{
    content: "";
    position: absolute;
    width:0;
    height: 0;
